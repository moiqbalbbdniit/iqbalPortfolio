    ...
    <footer className=" py-8 md:py-12 w-full">
      <div className="container max-w-7xl flex flex-col items-center justify-center gap-6 md:flex-row md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>https://www.linkedin.com/in/moiqbalbbdniit/</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
        <p className="text-sm text-muted-foreground text-center md:text-left">
          Made with ❤️ by{" "}
          <Link href="https://instagram.com/zaheen.iqbal" target="_blank" className="font-medium hover:underline" prefetch={false}>
            Iqbal
          </Link>
        </p>
      </div>
